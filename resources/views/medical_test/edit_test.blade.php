...
<div class="row">
    <div class="col-sm-12">
        <div class="box box-info">
            ...
            <!-- form start -->
            <form role="form" action="{{route('update_test', ['id' => $test->id])}}" method="post">
                {{csrf_field()}}
                <div class="box-body">
                    <div class="form-group col-sm-6">
                        <label>Test Name</label>
                        <input type="text" class="form-control" placeholder="Test name" name="test_name" value="{{$test->test_name}}">
                    </div>
                    <div class="form-group col-sm-6">
                        <label>Test Code</label>
                        <input type="text" class="form-control" placeholder="Test code" name="test_code" value="{{$test->test_code}}">
                    </div>
